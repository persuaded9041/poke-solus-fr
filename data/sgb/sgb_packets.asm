...
BlkPacket_Battle:
	...
	ATTR_BLK_DATA %011, 0,0,0, 10,07, 19,10 ; player HP bar: pal 0 ;solusnote - width matches new EXP bar palette below
	...
	ATTR_BLK_DATA %011, 3,3,0, 10,11, 19,11 ; solusnote - EXP bar : from coords 10 -> 19 (x) and 11 -> 11 (y) since one tile tall; pal 3, matches enemy mon
