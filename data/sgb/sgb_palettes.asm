...
ENDC
	...
	; solusnote - for the 3 HP bar palettes here (PAL_GREENBAR, YELLOWBAR, REDBAR), i'm replacing the second
		; color (30,26,15 for pale yellow on the 6 pokeball icons in battle)
		; with 04,17,31 (Gen 2's blue for EXP bar). I'm then using the user's HP bar palette for the EXP bar in data/sgb/sgb_packets.asm
	RGB 31,29,31, 04,17,31, 09,20,11, 03,02,02 ; PAL_GREENBAR
	RGB 31,29,31, 04,17,31, 26,20,00, 03,02,02 ; PAL_YELLOWBAR
	RGB 31,29,31, 04,17,31, 26,10,06, 03,02,02 ; PAL_REDBAR
