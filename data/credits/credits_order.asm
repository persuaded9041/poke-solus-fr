...
; commands that are used to go to the next set of credits texts.
	...
	db CRED_TRANS, CRED_BARDAKOFF, CRED_FLEURY, CRED_TEXT_FADE
	...
	db CRED_NOEPRODTEST, CRED_ZEHHUGO, CRED_NOAPRODTEST, CRED_HUDSONBUECHELE, CRED_TEXT_FADE
	db CRED_PRODUCER, CRED_IZUSHI, CRED_TEXT_FADE
	db CRED_EXECUTIVE, CRED_YAMAUCHI, CRED_TEXT_FADE_MON
	; Solus credits
	db CRED_DISASSEMBLY, CRED_PRET, CRED_TEXT_FADE
	db CRED_SOLUS_DEVELOPER, CRED_DECHRISSEN, CRED_TEXT_FADE_MON
	; end Solus credits
